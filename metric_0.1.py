...
print("Simblos de Christofell de primera clase")
print("0,1,1: ", christofell(0,1,1))

print("Simblos de Christofell de segunda clase")
print("0,1,1: ", conexion(0,1,1))

print("Tensor de Riemann 4-covarinte")
print("0,2,0,2: ", riemann(0,2,0,2))

print("Tensor de Riemann 3-covarinte y 1-contravariante")
print("0,2,0,2: ", TRiemann(0,2,0,2))
